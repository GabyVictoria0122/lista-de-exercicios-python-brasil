...
def converter_metros_para_centimetros():
    ...
    metros1 =  float(input("Insira um tamanho para ser convertido em centimetros"))
    centimetro1 = metros1 * 100
    print(f'Transformando para centímetros dá {centimetro1} cm')
